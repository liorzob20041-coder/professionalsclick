...
TRADE_SYNONYMS = {
    "חשמלאי": "חשמלאים",
    "חשמלאים": "חשמלאים",
    "אינסטלטור": "אינסטלטורים",
    "אינסטלטורים": "אינסטלטורים",
    "שיפוצניק": "שיפוצים",
    "שיפוצים": "שיפוצים",
    "מנעולן": "מנעולנים",
    "מנעולנים": "מנעולנים",
    "טכנאי מזגנים": "מיזוג אוויר",
    "טכנאי מיזוג אוויר": "מיזוג אוויר",
    "מזגנים": "מיזוג אוויר",
    "מיזוג אוויר": "מיזוג אוויר",
}
FIELD_I18N = {
...
def articles_index(lang):
    g.current_lang = lang
    articles = load_articles_list(lang)
    popular_articles = [a for a in articles if a.get("popular")]
    if not popular_articles:
        popular_articles = articles[:4]
